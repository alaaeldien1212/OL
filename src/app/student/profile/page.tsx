        ...
        >
          ...
          >
            <Card className="text-center py-8 mb-8" elevation="md">
              ...
              <p className="text-gray-300 mb-4">قارئ مبتدئ</p>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <Card elevation="sm" padding="lg">
                ...
                <p className="text-xs text-gray-400">رائع! استمر في القراءة</p>
              </Card>

              <Card elevation="sm" padding="lg">
                <div className="flex justify-between items-center mb-3">
                  <span className="text-gray-300">الدرجة الحالية</span>
                  <span className="text-3xl font-bold text-accent-red">85%</span>
                </div>
                <p className="text-xs text-gray-400">أداء ممتاز!</p>
              </Card>
            </div>
          </motion.div>
